...
<?php 
	if(isset($_POST['submit'])) {
		...
		$query = "INSERT INTO mspertemuan (";
		$query .= "ID_HeaderMataKuliah, NamaMataKuliah, ID_Pertemuan, Topic, Detail, Tugas";
		$query .= ") VALUES (";
		$query .= " '{$ID_HeaderMataKuliah}', '{$NamaMataKuliah}', '{$ID_Pertemuan}', '{$Topic}', '{$Detail}', '{$Tugas}'";
		$query .= ")";
            ...
            <div id="select">
                ...
                <div id="select-body">
					<form action="add_class.php" method="POST" enctype="multipart/form-data">
						...
						<tr>
							<td><input type="text" name="NamaMataKuliah" value="" placeholder="NamaMataKuliah"/><td>
						</tr>
						<tr>
							<td><input type="text" name="ID_Pertemuan" value="" placeholder="ID Pertemuan"/><td>
						</tr>
						<tr>
							<td><input type="text" name="Topic" value="" placeholder="Topic"/><td>
						</tr>
						<tr>
